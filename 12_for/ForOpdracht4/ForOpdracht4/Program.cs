...
namespace ForOpdracht4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                float x = vectors[0];//pak hier de waarde op index i (x)
                float y = vectors[1];//pak hier de waarde op index i + 1 (y)
                float z = vectors[2];//pak hier de waarde op index i + 2 (z)
